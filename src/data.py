...
def carregar_escolas_regulares() -> pd.DataFrame:
    ...
    df = pd.DataFrame(
        [
            ...
            ["3", "E.M. Demenciano Antônio de Moura (E.F.)", 20, 2817, 2829, 2825, 2818, 11289, 140.85, 141.45, 141.25, 140.90, 564.45],
...
def carregar_umei_creches() -> pd.DataFrame:
    ...
    dados = [
        ...
        ["POLO 6", "UMEI Darcy Ribeiro (E.F.)", 20, 1024, 1052, 1279, 1052],
        ...
        ["POLO 6", "C.C. Betânia (E.F.)", 19, 823, None, None, None],
